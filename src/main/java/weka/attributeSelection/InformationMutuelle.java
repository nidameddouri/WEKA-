 ...
 * @see NumericToBinary
 */
public class InformationMutuelle extends ASEvaluation implements
 ...
 * @return 
  ...
  public void buildEvaluator(Instances data) throws Exception {
    ...
    for (int i = 0; i < data.numAttributes(); i++) {
      if (i != classIndex) {
        m_InfoGains[i] = (ContingencyTables.entropyOverColumns(counts[i])+ContingencyTables.entropyOverRows(counts[i]) - ContingencyTables
  ...
  public static void main(String[] args) {
    runEvaluator(new InformationMutuelle(), args);
  }
