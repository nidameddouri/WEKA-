 ...
 * @see NumericToBinary
 */
public class HRatio extends ASEvaluation implements
 ...
 * @return 
  ...
  public void buildEvaluator(Instances data) throws Exception {
    ...
    for (int i = 0; i < data.numAttributes(); i++) {
      if (i != classIndex) {
        m_InfoGains[i] = (ContingencyTables.entropyConditionedOnRows(counts[i])+ ContingencyTables.entropyOverRows(counts[i]))/ContingencyTables.entropyOverColumns(counts[i]);
      }
    }
